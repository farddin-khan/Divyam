...
const featuredFallback = [
  ...
  {
    id: 'TestoStron-Booster',
    name: 'TestoStron-Booster',
    slug: 'testostro-booster',
    price: 340.99,
    compare_price: 420.0,
    images: ['/images/products/Dsign.jpeg'],
    category: { name: 'Wellness' },
    new_arrival: false,
    featured: true,
    best_seller: true,
  },
  {
    ...
    slug: 'Natural-Strength',
    price: 340.99,
    compare_price: 420.0,
    images: ['/images/products/TestraStone.jpeg'],
    category: { name: 'Wellness' },
    new_arrival: false,
    featured: true,
    best_seller: true,
