...
export default function Signup() {
  ...
  const handleSubmit = (event) => {
    ...
    downloadJsonFile(`signup-details-${Date.now()}.txt`, payload);
    setSaved(true);
  };
  ...
  return (
    <div className="section-padding py-16">
      <div className="max-w-3xl mx-auto rounded-3xl bg-white p-8 shadow-xl">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-text">Create a new account</h1>
          <p className="mt-3 text-sm text-gray-500">
            Enter your details and they will be saved in a JSON text file.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid gap-5">
          ...
          {saved && (
            <p className="text-sm text-green-600">Your signup details have been downloaded as a JSON text file.</p>
          )}
        </form>
