...
export default function PrivacyPolicy() {
  return (
    <>
      <SEO title="Privacy Policy" description="Privacy policy for Divyam Ayurveda website users and customers." />

      <div className="bg-primary pt-28 pb-14">
        <div className="section-padding text-center">
          <span className="text-secondary uppercase text-sm tracking-[0.32em] font-semibold">Privacy</span>
          <h1 className="heading-lg text-white mt-4">Privacy Policy</h1>
          <p className="text-white/70 max-w-3xl mx-auto mt-4 text-sm">
            At Divyam Ayurveda, we respect your privacy and are committed to protecting your personal information.
          </p>
        </div>
      </div>
